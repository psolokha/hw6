...
> Документ ведётся по мере выполнения шагов задания. Текущий охват: **Шаг 1 — CI/CD**, **Шаг 2 — безопасность**, **Шаг 3 — OAuth2**, **Шаг 4 — аналитика**.
...
- Для работы на проде: создать счётчик и задать `NEXT_PUBLIC_YM_COUNTER_ID` в Vercel + цели в интерфейсе Метрики.
